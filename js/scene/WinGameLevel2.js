 ...
 * 
 */
export default class WinGameLevel2 extends Phaser.Scene {
    constructor() {
    ...
    create() {
        ...
        //this.winGameSound = this.sound.add("gameover", { volume: 0.1 });
    ...
    composeHUD() {
        ...
        this.add.text(150, 200, "You Win!\nPress space to restart", {
            font: "50px Cambria",
            fill: "#ff0000"
        });
        this.ship = new Ship(this, 100, 100, null, null);
